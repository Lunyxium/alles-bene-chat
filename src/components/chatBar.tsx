...
export function ChatBar() {
    ...
    const onSend = form.handleSubmit(async ({ text }) => {
        ...
        if (textareaRef.current) {
            textareaRef.current.style.height = '96px' // 4 Zeilen Standard
        }
    })
    ...
    const handleTextareaChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
        ...
        textarea.style.height = '96px' // Min height (4 Zeilen)

        // Set new height based on scrollHeight, max 150px (etwa 7-8 Zeilen)
    ...
    useEffect(() => {
        const handleClickOutside = (e: MouseEvent) => {
            ...
            if (!target.closest('.emoji-container') && !target.closest('.format-container')) {
                setShowEmojis(false)
                setShowFormatting(false)
            }
        }
                    ...
                    >
                        ...
                        <div className="relative flex-1">
                            <textarea
                                ...
                                style={{
                                    minHeight: '96px', // 4 Zeilen ohne awkward mini-scroll
                                    maxHeight: '150px', // 7-8 Zeilen Maximum
                                    lineHeight: '1.5'
                                }}
                                onChange={(e) => {
